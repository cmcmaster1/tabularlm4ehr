...
def main():
    ...
    # Select the columns of interest and convert each row into a concatenated string of the form "value1; value2; value3; ..."
    df_train['text'] = df_train[variable].apply(lambda x: '; '.join(x), axis=1)
    df_test['text'] = df_test[variable].apply(lambda x: '; '.join(x), axis=1)
